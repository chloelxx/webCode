...
/******/ 	__webpack_require__.p = "/news_html/";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	(function (self, $) {
	    self.init = function () {
	        var vm = new _vue2.default({
	            ...
	            render: function render(h) {
	                ...
	                var x = h(_app2.default);
	                console.log("kkk", this);
	                console.log("app", _app2.default);
	                window.comment = _app2.default;
	    ...
	    // self.init();
	})(window.comment, _jquery2.default);
	window.comment.init();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	Component.options.__file = "D:\\h5\\src\\js\\components\\app.vue"
	...
	if (false) {(function () {
	  ...
	  module.hot.accept()
	  if (!module.hot.data) {
	    hotAPI.createRecord("data-v-ff0309e2", Component.options)
	  } else {
	    hotAPI.reload("data-v-ff0309e2", Component.options)
	  }
	})()}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var update = __webpack_require__(13)("c14df870", content, false);
	// Hot Module Replacement
	if(false) {
	 // When the styles change, update the <style> tags
	 if(!content.locals) {
	   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-ff0309e2\",\"scoped\":false,\"hasInlineConfig\":false}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./app.vue", function() {
	     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-ff0309e2\",\"scoped\":false,\"hasInlineConfig\":false}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./app.vue");
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Tips = function Tips(str, param) {
	  var p = "";
	  ...
	  $(".series").click(function () {
	    ...
	    if (flag) {
	      ...
	      var action = setInterval(function () {
	        ...
	        i++;
	        if (aud.currentTime * 1000 < aud.duration * 1000 && flag) {} else {
	...
	exports.default = {
	  ...
	  methods: {
	    ...
	    splitAtUser: function splitAtUser(str) {
	    ...
	    personPage: function personPage(uuid) {
	      var that = this;
	      event.stopPropagation();
	      console.log(uuid);
	      clearTimeout(that.clearTime);
	    ...
	    getAppURLData: function getAppURLData(urlObj) {
	      var that = this;
	      that.items = [];
	    ...
	    jumpToVotedList: function jumpToVotedList() {
	      if (jugePhoneType() == 1) {
	    ...
	    deleteComment11: function deleteComment11(list, index, flag) {
	    ...
	    deleteComment12: function deleteComment12(list, index, flag) {
	      var e = event || window.event;
	      e.stopPropagation();
	      var that = this;
	      /*if(list.author.UUID!==this.uuid){
	    ...
	    deleteComment: function deleteComment(list, index, isHot) {
	      var that = this;
	      if (list.author.UUID !== this.uuid) {
	        return;
	      }
	    ...
	    deleteSuccess: function deleteSuccess(id, index, isHot) {
	      var that = this;
	    ...
	    jumpSubCom: function jumpSubCom(id, index) {
	      var e = event || window.event,
	          that = this;
	      e.stopPropagation();
	    ...
	    sendClosePicToWeb11: function sendClosePicToWeb11() {
	      $("body").css("overflow", "auto");
	      $("#cover").css("display", "none");
	    },
	    sendClosePicToWeb: function sendClosePicToWeb() {
	      $("body").css("overflow", "auto");
	      $("#cover").css("display", "none");
	    },
	    ...
	    setLevelColor: function setLevelColor(lv) {
	      var arr = ["colorLv0", "colorLv1", "colorLv2", "colorLv3"];
	      return arr[lv];
	    },
	    jumpToPearsonPage: function jumpToPearsonPage(uuid, e) {
	      e.stopPropagation();
	      clearTimeout(this.clearTime);
	      if (jugePhoneType() == 1) {
	    ...
	    downloadImg: function downloadImg(src, e) {
	      e.stopPropagation();
	      if (jugePhoneType() == 1) {
	    ...
	    likeComment: function likeComment(e, list, index, hot) {
	      var e = event || window.event;
	      e.stopPropagation();
	      clearTimeout(this.clearTime);
	      this.dis = !this.dis;
	    ...
	    votedSuccess: function votedSuccess(id, vote, index) {
	      //app点赞成功后掉web端的函数
	    ...
	    getCommentID: function getCommentID(id) {
	      //插入评论
	      var that = this;
	      /*
	       *@note 按评论ID查询评论详情
	    ...
	    playAudio: function playAudio(size, e, list) {
	      e.stopPropagation();
	      clearTimeout(this.clearTime);
	      ...
	      if (that.isPlay || !list.isPlay) {
	        ...
	        var action = setInterval(function () {
	          ...
	          i++;
	          if (Math.ceil(aud[0].currentTime * 1000) < size * 1000 && list.isPlay) {} else if (Math.ceil(aud[0].currentTime * 1000) >= size * 1000) {
	            clearInterval(action);
	    ...
	    updataComment: function updataComment(id, index) {
	      //更新评论
	      var that = this;
	      console.log("id==", id);
	    ...
	    votedNewsSuccess: function votedNewsSuccess(objURL) {
	      var uuid = this.uuid;
	      if (jugePhoneType() == 1) {
	    ...
	    showImg: function showImg(e, index) {
	      e.stopPropagation();
	      var that = this;
	      clearTimeout(that.clearTime);
	      that.imageList = [];
	    ...
	    address: function address(p) {
	      if (p == "") {
	        return "暂无地址";
	      }
	      return p;
	    },
	    loadMoreCom: function loadMoreCom() {
	      var that = this;
	      var
	    ...
	    beforeTime: function beforeTime(publicTime) {
	    ...
	    publishTime: function publishTime(publicTime) {
	      var publicTime = new Date(publicTime),
	          now = new Date();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', [_c('div', {
	    staticClass: "text16 padding",
	    attrs: {
	      "id": "content"
	    },
	    domProps: {
	      "innerHTML": _vm._s(_vm.context)
	    }
	  }), _vm._v(" "), (_vm.voteSum > 0) ? _c('div', {
	    staticClass: "countMemberTop",
	    on: {
	  ...
	  }, _vm._l((_vm.voteData), function(vote, key) {
	    return (key <= 5) ? _c('a', {
	      ...
	      attrs: {
	        "src": vote.user.HeadImgURL
	      }
	    }), _vm._v(" "), _c('span', {
	      class: _vm.setLevel(vote.user.Level) + ' iconImg'
	    })]) : _vm._e()
	  })), _vm._v(" "), _c('div', {
	    staticClass: "text12",
	    staticStyle: {
	  ...
	  }, [_vm._v("\n      " + _vm._s(_vm.voteSum) + "人点赞\n      "), _c('span', {
	    staticClass: "iconImg sumTop"
	  })])]) : _vm._e(), _vm._v(" "), (_vm.hotItems.length) ? _c('div', {
	    staticClass: "hotComment",
	    attrs: {
	      "id": "commentBarHot"
	    }
	  }, [_vm._v("热门评论")]) : _vm._e(), _vm._v(" "), (_vm.hotItems.length) ? _c('div', {
	    staticClass: "text14 padding",
	    attrs: {
	      "id": "hot"
	    }
	  }, [_c('ol', {
	    staticClass: "comments-items"
	  }, _vm._l((_vm.hotItems), function(list, index) {
	    return _c('li', {
	      staticClass: "bbs-post stairCom"
	    }, [_c('div', {
	      staticClass: "bbs-post-self",
	      attrs: {
	        "id": list.id
	      },
	      on: {
	        "click": function($event) {
	          _vm.jumpSubCom(list.id, index)
	        }
	      }
	    }, [_c('div', {
	      staticClass: "bbs-headPic",
	      on: {
	        "click": function($event) {
	          _vm.jumpToPearsonPage(list.author.UUID, $event)
	        }
	      }
	    }, [_c('img', {
	      attrs: {
	        "src": list.author.HeadImgURL,
	        "alt": list.author.Nickname
	      }
	    }), _vm._v(" "), _c('span', {
	      class: _vm.setLevel(list.author.Level)
	    })]), _vm._v(" "), _c('div', {
	      staticClass: "bbs-comment-body"
	    }, [_c('div', {
	      staticClass: "pm"
	    }, [_c('div', {
	      staticStyle: {
	      ...
	      class: _vm.setLevelColor(list.author.Level) + ' text14',
	      staticStyle: {
	        "line-height": "100%"
	      }
	    }, [_vm._v(_vm._s(list.author.Nickname))]), _vm._v(" "), _c('a', {
	      staticClass: "text12 colorGray",
	      staticStyle: {
	        "line-height": "100%"
	      }
	    }, [_vm._v("\n                  " + _vm._s(list.seqNo) + "楼 \n                  " + _vm._s(_vm.beforeTime(list.createTime * 1000)) + "\n                ")])]), _vm._v(" "), _c('div', {
	      staticClass: "sprit likeIcon"
	    }, [_c('span', {
	      class: [list.vote == 1 ? _vm.dianzhan : _vm.downvote, 'iconImg'],
	      on: {
	        "click": function($event) {
	          _vm.likeComment($event, list, index, 1)
	        }
	      }
	    }), _vm._v(" "), _c('a', {
	      class: [list.vote == 1 ? 'color7A1AE0' : '', 'text12']
	    }, [_vm._v(_vm._s(list.upvotes))])])]), _vm._v(" "), _c('div', {
	      staticClass: "comment-text"
	    }, [_c('p', {
	      staticClass: "detailWord",
	      domProps: {
	        "innerHTML": _vm._s(_vm.splitAtUser(list.text))
	      }
	    })]), _vm._v(" "), (list.images && list.images.list && list.images.list.length > 0) ? _c('div', {
	      staticClass: "comment-img"
	    }, [_vm._l((list.images.list), function(img, key) {
	      return (list.images.list.length == 1) ? _c('div', {
	        staticClass: "oneImg",
	        on: {
	          "click": function($event) {
	            _vm.showImg($event, key)
	          }
	        }
	      }, [_c('img', {
	        class: [img.ImageAttr.width > img.ImageAttr.high ? 'setHeight' : 'setWidth'],
	        attrs: {
	          "src": img.ThumbUrl,
	          "width": img.ImageAttr.width,
	          "height": img.ImageAttr.high
	        }
	      })]) : _vm._e()
	    }), _vm._v(" "), _vm._l((list.images.list), function(img, key) {
	      return (list.images.list.length == 2) ? _c('div', {
	        staticClass: "twoImg",
	        on: {
	          "click": function($event) {
	            _vm.showImg($event, key)
	      ...
	      return (list.images.list.length >= 3) ? _c('div', {
	        staticClass: "thumbnailHidden",
	        on: {
	          "click": function($event) {
	            _vm.showImg($event, key)
	          }
	    ...
	    })], 2) : _vm._e(), _vm._v(" "), (list.audio) ? _c('div', {
	      staticClass: "audio"
	    }, [_c('audio', {
	      staticStyle: {
	        "display": "none"
	      ...
	      on: {
	        "click": function($event) {
	          _vm.playAudio(list.audio.length, $event, list)
	        }
	      }
	    }, [_vm._m(0, true), _vm._v(" "), _c('div', {
	      staticClass: "expires"
	    }, [(list.audio.expires > 0) ? _c('span', {
	      staticClass: "color7A1AE0"
	    }, [_vm._v(_vm._s(list.audio.expires) + "后过期")]) : _vm._e()]), _vm._v(" "), _c('div', {
	      staticClass: "allTimes"
	    }, [_c('span', {
	      staticClass: "color7A1AE0"
	    }, [_vm._v(_vm._s(list.audio.length) + "\"")])])])]) : _vm._e(), _vm._v(" "), (list.position) ? _c('div', {
	      staticStyle: {
	        "background-color": "white"
	      }
	    }, [_c('a', {
	      staticClass: "colorGray text12"
	    }, [_c('span', {
	      staticClass: "iconImg address"
	    }), _vm._v(" " + _vm._s(_vm.address(list.position)) + "\n              ")])]) : _vm._e()]), _vm._v(" "), (list.subComments && list.subComments.length > 0) ? _c('ul', {
	      staticClass: "subComment"
	    }, [_vm._l((list.subComments), function(subCom, key) {
	      return _c('li', {
	        staticClass: "sendComLI",
	        on: {
	          "click": function($event) {
	            _vm.jumpSubCom(list.id, index)
	          }
	        ...
	        class: _vm.setLevelColor(subCom.author.Level)
	      }, [_vm._v(_vm._s(subCom.author.Nickname) + "：")]), _vm._v(" " + _vm._s(subCom.text) + "\n                    "), _c('span', {
	        staticClass: "publicTime"
	      }, [_vm._v(_vm._s(_vm.beforeTime(subCom.createTime * 1000)))])])])])])
	    }), _vm._v(" "), (list.children > 2) ? _c('div', {
	      staticClass: "color7A1AE0 text14"
	    }, [_vm._v("更多" + _vm._s(list.children) + "条回复")]) : _vm._e()], 2) : _vm._e()])])
	  }))]) : _vm._e(), _vm._v(" "), (_vm.hotItems.length) ? _c('div', {
	    staticStyle: {
	    ...
	    staticClass: "color7A1AE0 text12",
	    staticStyle: {
	      "float": "right"
	    },
	    on: {
	  ...
	  }, [_vm._v(_vm._s(_vm.sortComment.text))]), _vm._v(" "), _c('span', {
	    class: [_vm.sortComment.sort ? 'sortComments' : 'sortCommentsRe', 'iconImg'],
	    staticStyle: {
	      "float": "right"
	    }
	  })])]) : _vm._e(), _vm._v(" "), _c('div', {
	    staticClass: "allComment padding",
	    attrs: {
	      "id": "all"
	    }
	  }, [(_vm.items.length) ? _c('ol', {
	    staticClass: "comments-items"
	  }, [_vm._l((_vm.items), function(list, index) {
	    return _c('li', {
	      staticClass: "bbs-post stairCom",
	      attrs: {
	        "id": list.id
	      ...
	      class: _vm.setLevel(list.author.Level) + ' iconImg'
	    })]), _vm._v(" "), _c('div', {
	      staticClass: "bbs-comment-body"
	    }, [_c('div', {
	      staticClass: "pm"
	      ...
	      on: {
	        "click": function($event) {
	          _vm.likeComment($event, list, index, 0)
	        }
	      }
	    }), _vm._v(" "), _c('a', {
	      class: [list.vote == 1 ? 'color7A1AE0' : '', 'text12']
	    ...
	    staticClass: "text14 colorGray",
	    staticStyle: {
	      "text-align": "center",
	      "margin": "0.25px 0rem 0.15rem 0rem"
	    },
	    attrs: {
	      "id": "loadMore"
	    },
	  ...
	  }, [_vm._v("加载更多评论")])], 2) : _vm._e()]), _vm._v(" "), (_vm.isComment) ? _c('div', {
	    staticClass: "text14 colorGray",
	    staticStyle: {
	      "text-align": "center",
	      "margin": "0.25px 0rem 0.15rem 0rem"
	    ...
	    staticClass: "iconImg noDataTips"
	  }), _vm._v(" "), _c('p', [_vm._v("还没有人发言呢！快抢沙发！")])]) : _vm._e()])
	},staticRenderFns: [function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    staticClass: "series sprit"
	  }, [_c('span', {
	    staticClass: "iconImg audio0"
	  })])
	...
	if (false) {
	  module.hot.accept()
	  if (module.hot.data) {
	     require("vue-hot-reload-api").rerender("data-v-ff0309e2", module.exports)
	  }
	}
