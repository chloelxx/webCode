...
function popFrame(str, key, data) {
	(0, _jquery2.default)("#modelFrame").show();
	(0, _jquery2.default)("#defineWord").html(str);
	return {
		clickBtn: function clickBtn(fn) {
			(0, _jquery2.default)("#modelFrame").click(function (e) {
				e = e || window.event;
				console.log(e);
				if (e.target.id == "confirm") {
					(0, _jquery2.default)("#modelFrame").hide();
					if (fn) {
						fn();
					}
					return true;
